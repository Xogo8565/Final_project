            ...
            <div>
                ...
                <div class="row mt-3 mb-5" id="boardBox">
                    <div class="col">
                        ...
                        <h3>
                            <span id="boardInfo"><i class="fa-solid fa-book"></i>  &nbsp;후원 글 보기</span>
                        </h3>
                        ...
                        <table class="table table-hover">
                            <thead style="border-top: 1px solid lightgray;">
                                <tr>
                                    ...
                                    <th scope="col" class="col-3">계좌번호</th>
                                   ...
                                   <c:otherwise>
                                        <c:forEach items="${list}" var="dto">
                                            <tr>
                                                ...
                                                <td><a href="/supportBoard/view?nowPage=1&seq_board=${dto.SEQ_BOARD}">${dto.BOARD_TITLE}</a></td>
                                                <td>${dto.SUPPORT_BANK}</td>
