...
본 이용약관은 “Comme”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.
...
2. 수집하는 개인정보 항목
ID, 성명, 비밀번호, 주소, 휴대폰번호, 이메일, 생년월일, 암호화된 이용자 확인값(CI)
3. 개인정보 보유 및 이용기간
회원탈퇴 시까지 (단, 관계 법령에 보존 근거가 있는 경우 해당 기간 시까지 보유, 개인정보처리방침에서 확인 가능)
                ...
                <div class="signupIcons">
                    <div class="row">
                        <div class="col d-flex justify-content-center">
                            <a class="clsSignupBtn" href="javascript:toGeneralSignup()">
                                <div class="row">
                        ...
                        <div class="col d-flex justify-content-center">
                            <a class="clsSignupBtn" href="javascript:toBusinessSignup()">
                                <div class="row">
                ...
                <div class="row toBack">
                    <div class="col d-flex justify-content-center">
                        <button type="button" class="btn btn-secondary btnBack">뒤로가기</button>
                    </div>
                </div>
