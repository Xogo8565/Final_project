...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="patron_container">
            ...
            <div class="patron">
                <div class="input">
                    <input type="text" name = "name" id = "name" value="${loginSession.member_id}">
                    <input type="tel" name ="tel" id ="tel" value="${loginSession.member_phone}">
                    <input type="email" name = "email" id="email" value="${loginSession.member_email}">
                </div>
                <div class="select">
                    <label for="selectAll">
        ...
        <div class="payment_container">
            ...
            <div class="payment">
                ...
                <div class="button">
                    <button type="button">신청(후원)하기</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    selectAll.addEventListener("click", function () {
        if (this.checked) select.forEach((e) => { e.checked = true;});
         else select.forEach((e) => {e.checked = false;});
    });
